<div class="col-md-12">
    <div class="form-group{{ $errors->has("value") ? ' has-error' : '' }}">
        ...
        {!! Form::text("value", null, ["class" => "form-control", 'id'=>'value','required','placeholder'=>"Digite um Nome",'required'])  !!}
...
<div class="col-md-6">
    <div class="form-group{{ $errors->has("type") ? ' has-error' : '' }}">
        ...
        {!! Form::select("type", $types, null, ["class" => "form-control", 'id'=>'price_id','required','placeholder'=>"Escolha o tipo do item",'required'])  !!}
